...
public class EmployeeFrame extends Frame {
	...
	public EmployeeFrame() {
		...
		this.employeeAddressLbl.setBounds(320, 210, 110, 20);
		...
		clearButton.setBounds(200, 450, 100, 30);
		add(clearButton);
		clearButton.addActionListener(new EmployeeHandler(this));
